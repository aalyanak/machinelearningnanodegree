...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing:
            ...
            self.epsilon = math.fabs(math.cos(self.alpha*self.t)) # F-A
    ...
    def build_state(self):
        ...
        state = str(waypoint) + "_" + str(inputs['light']) + "_" + str(inputs['left']) + "_" + str(inputs['right']) + "_" +  str(inputs['oncoming'])
        if self.learning:
...
def run():
    ...
    #agent = env.create_agent(LearningAgent, learning=True, epsilon=1.0, alpha=0.4) F-A
    ...
    #sim.run(n_test=100, tolerance= 0.005) F-A
